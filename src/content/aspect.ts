import type { AspectNote } from '../lib/types.ts';
...
/* Only pairs that appear nowhere else on the sheet. Pairs carried by PREFIXES
   (pisati/napisati, gledati/pogledati, učiti/naučiti, raditi/uraditi,
   čitati/pročitati) or by PATTERNS (kupovati/kupiti, uzimati/uzeti,
   otvarati/otvoriti) are shown once, there — one view per fact. */
