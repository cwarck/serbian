...
const PREP_GROUPS = [
  ...
  },
  {
    ...
    rows: [
      ...
      { prep: 's/sa', icon: 'off', uses: [{ case: 'gen', icon: 'off', meaning: { en: 'from off, down from', ru: 'с, сверху/из' }, sr: 'Silazim sa autobusa.', tr: { en: 'I am getting off the bus.', ru: 'Я выхожу из автобуса.' } }] },
      { prep: 'do', icon: 'limit', uses: [{ case: 'gen', meaning: { en: 'up to, until', ru: 'до' }, sr: 'Idem do stanice.', tr: { en: 'I am going up to the station.', ru: 'Я иду до станции.' } }] },
      ...
      { prep: 'prema', icon: 'toward', uses: [{ case: 'dat', meaning: { en: 'toward, facing', ru: 'к, по направлению' }, sr: 'Okrenut sam prema moru.', tr: { en: 'I am turned toward the sea.', ru: 'Я повернут к морю.' } }] },
    ]
  },
  {
    key: 'prep.group.time',
    rows: [
      { prep: 'pre', icon: 'before', uses: [{ case: 'gen', meaning: { en: 'before', ru: 'до, перед' }, sr: 'Pre ručka pijem vodu.', tr: { en: 'Before lunch I drink water.', ru: 'Перед обедом я пью воду.' } }] },
